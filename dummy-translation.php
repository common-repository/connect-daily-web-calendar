...
function dummy() {
    ...
    __('COM_CONNECTDAILY_AddEvents');
    __('COM_CONNECTDAILY_Address');
    __('COM_CONNECTDAILY_Alerts');
    ...
    __('COM_CONNECTDAILY_Events');
    __('COM_CONNECTDAILY_EventFilterInstructionsPlaceHolder');
    __('COM_CONNECTDAILY_EventID');
    __('COM_CONNECTDAILY_Every');
    __('COM_CONNECTDAILY_EveryOther');
    __('COM_CONNECTDAILY_FilterBy');
    __('COM_CONNECTDAILY_HINT_AddEvents');
    __('COM_CONNECTDAILY_iCalendar');
    __('COM_CONNECTDAILY_iCalExport');
    ...
    __('COM_CONNECTDAILY_WatchTutorial');
